...
var completedTasksHolder=document.querySelector(".task-list_completed");//.task-list_completed
...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="task-input task-input_checkbox";
    editInput.type="text";
    editInput.className="task-input task-input_text";
...
var taskCompleted=function(){
    ...
    //Append the task list item to the .task-list_completed
    var listItem=this.parentNode;
